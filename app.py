...
if selected == "Parkinsons Prediction":
    ...
    with col5:
        Shimmer_dB = st.text_input('MDVP:Shimmer(dB)', "22.4")

    with col1:
        APQ3 = st.text_input('Shimmer:APQ3', value="0.12")

    with col2:
        APQ5 = st.text_input('Shimmer:APQ5' ,"0.054")

    with col3:
        APQ = st.text_input('MDVP:APQ', "12")
